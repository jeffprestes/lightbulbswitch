...
public class IoTClient {
     ...
     */
    public IoTClient(String parBroker)     {
     ...
     */
    public IoTClient(String parBroker, String parTopic)     {
     ...
     */
    public IoTClient(String parBroker, String parTopic, String parClientId, String parPort) {
        this.broker = parBroker;
    ...
    */
    ...
    private void initialize()      {
        ...
        try {
            ...
            client.setCallback(new IoTMqttListener(pin, client, this.topic));
            System.out.println("Listener defined. Waiting for orders...");
            
            InetAddress address = InetAddress.getLocalHost();
            
            this.publish("Machine is initialized in " + IoTClient.getIp() + " and waiting for orders...", client);
